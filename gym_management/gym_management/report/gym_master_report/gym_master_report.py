...
def get_data(filters):
	...
	data = frappe.db.sql(f"""select name,member_name,subscription_plan,master_name, master_fee,total_fee,fee_paid,balance from `tabGym Registration Form` where docstatus=1 {conditions} and do_you_want_personal_trainer="Yes";""", values)
	return data
